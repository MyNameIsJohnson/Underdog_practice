let fs = require('fs');
var babyName2020 = fs.readFileSync("./baby_names_2020_short.txt", 'utf-8').toUpperCase().split('\n');
...
console.log('getScrabbleWordFromBabyName', getScrabbleWordFromBabyName(babyName2020, textByLine))
